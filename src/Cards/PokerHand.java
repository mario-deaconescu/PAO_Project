...
public class PokerHand extends CardHand implements Comparable<PokerHand> {
    ...
    public Category getCategory(){
        ...
        if(flush && straight){
            ...
            if(sorted.getFirst().getRank() == Card.Rank.TEN){
        ...
        Map<Card.Rank, Long> rankCounts = sorted.stream().collect(Collectors.groupingBy(Card::getRank, Collectors.counting()));
    ...
    public int getHandValue(){
        ...
        var highestCard = getHighestCard().getRank().getValue();
