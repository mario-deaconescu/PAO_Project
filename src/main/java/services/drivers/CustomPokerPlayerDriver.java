...
public class CustomPokerPlayerDriver extends DriverBase {

    private static final CustomPokerPlayerDriver instance = new CustomPokerPlayerDriver();

    public static CustomPokerPlayerDriver getInstance() {
        return instance;
    }

    private CustomPokerPlayerDriver() {
        super("custom_poker_players", Arrays.asList(
